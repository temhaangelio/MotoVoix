...
const TURKISH_COPY = {
  ...
  "Kayıt data/local-db.json dosyasına yazılır.": ["The record is saved to data/local-db.json.", "L’enregistrement est sauvegardé dans data/local-db.json."],
  ...
  "Tüm ayarlar data/local-db.json içinde saklanır.": ["All settings are stored in data/local-db.json.", "Tous les paramètres sont stockés dans data/local-db.json."],
