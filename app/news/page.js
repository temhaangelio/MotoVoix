        ...
        <section className="mb-14 rounded-[18px] border border-outline-variant/20 sm:mb-20">
          <div className="flex flex-col justify-between gap-8 px-5 py-8 sm:px-8 sm:py-10 md:flex-row md:items-end md:px-10 md:py-16">
            <div className="max-w-2xl">
              <span className="font-label text-xs uppercase tracking-[0.3em] text-primary mb-4 block">HEADLINES / BREAKING</span>
              <h1 className="font-headline text-[3.2rem] font-light tracking-tight leading-[0.92] mb-5 text-zinc-50 sm:text-6xl md:text-7xl lg:text-8xl">Motorcycle News.</h1>
              <p className="max-w-xl font-body text-base leading-relaxed text-zinc-200 sm:text-lg md:text-xl">New models, manufacturer announcements, racing updates, and key industry moves in one stream.</p>
            </div>
          </div>
        </section>
      ...
      <section className="w-full border-t border-outline-variant/10 bg-surface-container-low py-16 sm:py-20 md:py-24">
        <div className="mx-auto flex max-w-7xl flex-col items-stretch justify-between gap-10 px-4 sm:px-6 md:flex-row md:items-center md:gap-12 md:px-8">
          <div className="max-w-xl text-left">
            <h3 className="font-headline text-4xl mb-4 sm:text-5xl">Headlines in your inbox.</h3>
            <p className="font-body text-on-surface-variant">Subscribe for new model launches, industry updates, and this week&apos;s standout motorcycle stories.</p>
          </div>
          <div className="flex w-full flex-col gap-3 md:w-auto md:min-w-[28rem] md:flex-row md:items-end md:gap-4">
            <input className="min-h-12 w-full bg-transparent border border-outline px-4 py-3 font-label text-base uppercase tracking-[0.18em] text-on-surface transition-all focus:border-primary focus:outline-none md:w-80" placeholder="Email Address" type="email" />
            <button className="min-h-12 w-full bg-primary-container px-8 py-3 font-label text-sm uppercase tracking-widest text-on-primary-container transition-all hover:opacity-90 md:w-auto md:px-12">Subscribe</button>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 sm:px-6 md:grid-cols-2 md:gap-8 md:px-8">
          <div className="space-y-8 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start">
              <span className="font-headline text-2xl text-zinc-100">MOTOVOIX</span>
            </div>
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 md:justify-start">
              <Link className="font-body text-sm text-zinc-500 uppercase tracking-widest hover:text-zinc-100 transition-all" href="/news">News</Link>
              ...
              <Link className="font-body text-sm text-zinc-500 uppercase tracking-widest hover:text-zinc-100 transition-all" href="/about">About</Link>
          ...
          <div className="flex flex-col items-center justify-between gap-6 text-center md:items-end md:text-right">
            <p className="font-body text-sm text-zinc-500 uppercase tracking-widest">© 2026 MotoVoix.</p>
