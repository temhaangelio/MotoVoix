...
function seedAnalytics() {
  ...
  return {
    ...
    countries: [
      { code: "TR", label: "Turkey", percentage: 54 },
      { code: "DE", label: "Germany", percentage: 16 },
      { code: "GB", label: "United Kingdom", percentage: 12 },
      { code: "US", label: "ABD", percentage: 10 },
      { code: "IT", label: "Italy", percentage: 8 },
    ],
    devices: [
      { code: "android", label: "Android", percentage: 46 },
      { code: "iphone-other", label: "Other iPhone models", percentage: 38 },
      { code: "iphone-17", label: "iPhone 17", percentage: 12 },
      { code: "other", label: "Other", percentage: 4 },
    ],
  };
}
...
function defaultDb() {
  ...
  const extraDraft = {
    ...
    description: "Technical notes before publication.",
    excerpt: "Technical notes before publication.",
    body: "This post is not published yet. You can edit and publish it from the admin panel.",
    category: "racing",
    tags: "ducati, draft",
    date: nowIso(),
    image: "",
  ...
  const extraScheduled = {
    ...
    description: "Weekend grid notes.",
    excerpt: "Weekend grid notes.",
    body: "Scheduled post. It will appear on the site at the selected time.",
    category: "racing",
    tags: "motogp, preview",
  ...
  return {
    settings: {
      ...
      description: "Service d’actualités moto indépendant.",
    ...
    ads: [
      {
        ...
        description: "Demo ad. It can be displayed in the visitor feed.",
        ctaLabel: "Discover",
    ...
    newsletters: [
      {
        ...
        content: "Weekly motorcycle news demo content.",
        status: "sent",
        scheduled_at: null,
      ...
      },
      {
        ...
        preview_text: "The next issue is scheduled.",
        content: "Scheduled newsletter draft.",
        status: "scheduled",
    ...
    subscribers: [
      ...
      { id: "sub_3", name: "Léa Bouchon", email: "lea.bouchon@gmail.com", status: "active", source: "Newsletter", created_at: isoDaysAgo(14) + "T16:00:00.000Z" },
      ...
      { id: "sub_9", name: "Manon Vesper", email: "manon.vesper@gmail.com", status: "pending", source: "Newsletter", created_at: isoDaysAgo(2) + "T16:00:00.000Z" },
...
export function createAd(input) {
  ...
  const ad = {
    ...
    ctaLabel: input.ctaLabel || "Discover",
